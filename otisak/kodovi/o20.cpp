...
class C : public A {		// da je ovde B ne bi imali aabc nego ababc za C c;
	private:
		B b;				// da je ovde A ne bi imali abc nego aac za C c;
	public:
		C() {cout << "CK";}
		~C() {cout << "CD";}
};
...
int main() {
	B b;					// A pa B
	C c;					// A za B, A za C, pa onda B, i C na kraju
	return 0;
}
